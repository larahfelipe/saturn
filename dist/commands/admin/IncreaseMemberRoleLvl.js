...
class IncreaseMemberRoleLvl extends Command_1.default {
    constructor(bot) {
        super(bot, {
    ...
    async run(msg, _) {
        ...
        embed
            ...
            .setColor('#6E76E5');
        await UpdateGuildMemberService_1.handleGuildMemberElevation(targetMember, msg)
...
exports.default = IncreaseMemberRoleLvl;
